        ...
        <div className="relative z-10 flex flex-col justify-center px-16">
          ...
          >
            <Link to="/" className="flex items-center gap-2 mb-12">
              ...
              <span className="font-display text-3xl font-bold text-foreground">FinQuest</span>
            </Link>

            <h1 className="font-display text-4xl md:text-5xl font-bold text-foreground mb-6">
              Master Finance
              <br />
              <span className="text-gradient-primary">Through Play</span>
            </h1>

            <p className="text-lg text-muted-foreground mb-8 max-w-md">
              Join thousands of learners building real financial skills with our gamified platform. No risk, all reward.
            </p>
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-muted-foreground">Practice with $10,000 virtual credits</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-gain/20 flex items-center justify-center">
                  <span className="text-gain font-bold">✓</span>
                </div>
                <span className="text-muted-foreground">Learn from interactive modules</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-gain/20 flex items-center justify-center">
                  <span className="text-gain font-bold">✓</span>
                </div>
                <span className="text-muted-foreground">Compete on global leaderboards</span>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12">
        ...
        >
          ...
          <Link to="/" className="flex items-center gap-2 mb-8 lg:hidden">
            ...
            <span className="font-display text-2xl font-bold text-foreground">FinQuest</span>
          </Link>
